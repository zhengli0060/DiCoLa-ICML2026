...
from compare_algs.causallearn_package.utils.KCI.KCI import KCI_CInd, KCI_UInd
from compare_algs.causallearn_package.utils.FastKCI.FastKCI import FastKCI_CInd, FastKCI_UInd
from compare_algs.causallearn_package.utils.RCIT.RCIT import RCIT as RCIT_CInd
from compare_algs.causallearn_package.utils.RCIT.RCIT import RIT as RCIT_UInd
from compare_algs.causallearn_package.utils.PCUtils import Helper
...
class CIT_Base(object):
    ...
    def __init__(self, data, cache_path=None, **kwargs):
        ...
        self.max_runtime_sec = data.shape[1] * 10
...
class FisherZ(CIT_Base):
    ...
    def __call__(self, X, Y, condition_set=None):
        ...
        p : the p-value of the test
        '''
        if (time.time() - self._init_time) > self.max_runtime_sec:
                raise TimeoutError("cit exceeded the maximum allowed runtime.")
