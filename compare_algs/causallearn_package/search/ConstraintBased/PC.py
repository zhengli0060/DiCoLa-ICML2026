...
from compare_algs.causallearn_package.utils.PCUtils import Helper, Meek, SkeletonDiscovery, UCSepset
from compare_algs.causallearn_package.utils.PCUtils.BackgroundKnowledgeOrientUtils import \
...
def pc_alg(
    ...
    **kwargs
    ...
    return cg, indep_test.get_test_num()
